...
@register_model('image_captioning_crnn')
...
class CRNNDecoder(FairseqIncrementalDecoder):
    """CRNN decoder."""
    def __init__(
...
@register_model_architecture('image_captioning_crnn', 'image_captioning_crnn')
...
@register_model_architecture('image_captioning_crnn', 'decoder_crnn')
